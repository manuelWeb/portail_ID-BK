...
function change(jsonObj) {
  ...
  if (
    ...
    coverId.src = jsonObj.cover.bv;
    coverBk.src = jsonObj.cover.bv;
  } else if (
    navigator.language == "de" ||
    navigator.language == "dei-DE" ||
    navigator.language == "dsb-DE"
  ) {
...
$(".js-carousel").each(function() {
  var $carousel = $(this),
    ...
    slide = function() {
      ...
      if (dir == "next") {
        moveto = after < containerWidth
          ? curPos - after
          : curPos - containerWidth - 20;
      } else {
